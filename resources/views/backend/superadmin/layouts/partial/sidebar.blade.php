...
<li class="menu-item" aria-haspopup="true">
        <a href="{{ route('welcome') }}" class="menu-link" target="_blank">
            ...
            <span class="menu-text">Front Website</span>
        </a>
</li>
...
<li class="menu-item menu-item-submenu {{ Request::is('superadmin/catelog*') ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
        ...
        <div class="menu-submenu">
            ...
            <ul class="menu-subnav">
                    ...
                    <li class="menu-item menu-item-submenu {{ Request::is('superadmin/catelog/manufacturer*') ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                        <a href="javascript:;" class="menu-link menu-toggle">
                                <i class="menu-bullet menu-bullet-line">
                                    <span></span>
                                </i>
                        ...
                        <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item {{ Request::is('superadmin/catelog/manufacturer') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                ...
                                <li class="menu-item {{ Request::is('superadmin/catelog/manufacturer/create') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                        <a href="{{ route('superadmin.manufacturer.create') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                            </i>
                                            <span class="menu-text">Create New Manufacturer</span>
                                        </a>
                                </li>
                                </ul>
                        </div>
    ...
    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
        ...
        <span class="svg-icon menu-icon">
            ...
            <span class="menu-text">Home Page Setting</span>
            <i class="menu-arrow"></i>
        </a>
        <div class="menu-submenu">
            <i class="menu-arrow"></i>
            <ul class="menu-subnav">
                ...
                <li class="menu-item menu-item-submenu {{ Request::is('superadmin/front/banner*') ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <i class="menu-bullet menu-bullet-line">
                            <span></span>
                        </i>
                    ...
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            <li class="menu-item {{ Request::is('superadmin/front/banner') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item {{ Request::is('superadmin/front/banner/create') ? 'menu-item-active' : '' }}" aria-haspopup="true">
