    ...
    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <form class="form" id="form" name="form" enctype="multipart/form-data" action="{{route('superadmin.banner.update',$banner->id)}}" method="post">
                    @csrf
                    @method('PUT')
                ...
                <div class="col-xl-8">
                    <div class="my-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control border border-primary" type="text" value="{{$banner->title}}" placeholder="Enter Banner Text" name="title" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control select2" id="status" name="status" autocomplete="off">
                                    ...
                                    <option value="0" {{$banner->status == 0 ? 'selected' : '' }}>Not Active</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 ">
                                <div class="image-input image-input-empty image-input-outline" id="kt_image_9" style="background-image: url({{asset('banner')}}/{{$banner->image}})">
