    ...
    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <form class="form" id="form" name="form" enctype="multipart/form-data" action="{{route('superadmin.user.update',$user->id)}}" method="post">
                    @csrf
                    @method('PUT')
                    <a href="{{route('superadmin.user.index')}}" class="btn btn-light-primary font-weight-bolder mr-2">
                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control border border-info @error('email') is-invalid @enderror"
                                type="email" name="email" autocomplete="email" value="{{$user->email}}" disabled/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control select2" id="role" name="role_id" autocomplete="off">
