...
<html lang="en">
	...
	<head>
		...
		<link href="{{ asset('resource/backend/') }}/assets/css/pages/login/login-1.css?v=7.0.5" rel="stylesheet" type="text/css" />
        ...
        <link rel="shortcut icon" href="{{ asset('resource/backend/') }}/assets/media/logos/favicon.ico" />
				...
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<a href="#" class="text-center mb-10">
							<img src="{{ asset('resource/backend/') }}/assets/media/logos/logo-letter-1.png" class="max-h-70px" alt="" />
						</a>
						<!--end::Aside header-->
						<!--begin::Aside title-->
						<h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #986923;">Favorite brands
						<br />and hottest trends.</h3>
						<!--end::Aside title-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url({{ asset('resource/backend/') }}/assets/media/svg/illustrations/login-visual-1.svg)"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
